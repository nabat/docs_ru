...
<div class="container">
    <div class="row-fluid">
        <p>
        </p><h4>Акт № %INVOICE_NUM% от %DATE%</h4>
        <p></p>
        <hr>
        ...
        <p>
            Вышеперечисленные услуги выполнены качественно и в срок. Заказчик претензий по обьему, качеству и срокам
            оказания услуг не имеет.
        </p>

        <div class="row-fluid">
            <div class="span6"> Исполнитель:____________</div>
            <div class="span6"><p class="text-right">Заказчик:____________</p></div>
            <div id="mp">МП</div>
